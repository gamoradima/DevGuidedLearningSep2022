namespace Terrasoft.Configuration
{
	...
	public class UsrRealtyServiceSchema : Terrasoft.Core.SourceCodeSchema
	{
		...
		protected override void InitializeProperties() {
			...
			UId = new Guid("7f3e43a9-12ae-43bb-9160-7386395456d2");
			Name = "UsrRealtyService";
			ParentSchemaUId = new Guid("50e3acc0-26fc-4237-a095-849a1d534bd3");
			CreatedInPackageId = new Guid("4a952ba2-ebf6-4de2-b3ff-387c292e1014");
			ZipBody = new byte[] { 31,139,8,0,0,0,0,0,4,0,43,73,45,46,1,0,12,126,127,216,4,0,0,0 };
		}
		...
		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			...
			realUIds.Add(new Guid("7f3e43a9-12ae-43bb-9160-7386395456d2"));
		}
